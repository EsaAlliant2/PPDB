               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                           <div class="center-desk">
                              <div class="logo">
                                 <a href="index.html"><img src="{{ asset('assets/images/menu_icon.png') }}" alt="#" /></a>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        <ul class="btn">
                           <li class="down_btn"><a href="#">Daftar</a></li>
                     ...
                     <div class="carousel-caption">
                        <div class="row">
                           <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                              <div class="text-bg">
                                 <h1>Smk<br> Antartika <br>1 Sidoarjo</h1>
                           ...
                           <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                              <div class="images_box">
                                 <figure><img src="{{ asset('assets/images/sekolah.jpg') }}"></figure>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="container-fluid ">
                     <div class="carousel-caption">
                        <div class="row">
                           ...
                           <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                              <div class="images_box">
                                 <figure><img src="{{ asset('assets/images/menu_icon.png') }}"></figure>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="carousel-caption ">
                        <div class="row">
                           <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                              <div class="text-bg">
                                 <h1>Kontak<br>  <br></h1>
                                 <p> Jl.Siwalanpanji, Kec. Buduran Sidoarjo, Indonesia  +6231-8962851</p>
                                 <i class="nav-icon fa fa-phone">+6231-8962851</i>
                                 <a class="read_more" href="#">Read more</a>
                              </div>
                           </div>
                           <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                              <div class="images_box">
                                 <figure><img src="{{ asset('assets/images/sekulah.jpg') }}"></figure>
                              </div>
                           </div>
                        </div>
                     </div>
